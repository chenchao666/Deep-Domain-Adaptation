...
##############################################################################
    ...
    def LoadTarget(self):
        ...
        LapMatrix=CalLapMatrix(TargetData,alpha=0.005, K=int(TargetData.shape[0]/50))
        return TargetData, TargetData, TargetLabel, LapMatrix
...
def Cal_pairwise_dist(Data):
    ...
    # DataVector=ImgVectorize_CNN(Data)
...
def ImgVectorize(Data):
    DataVector=zeros((Data.shape[0],32*32*3))
